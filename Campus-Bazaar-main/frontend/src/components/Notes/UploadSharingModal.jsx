...
export default function UploadSharingModal({ isOpen, onClose, fetchNotes, mode }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      await api.post('/api/notes/upload-sharing', formData, {
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          ...
          >
            <Dialog.Panel className="w-full max-w-md rounded-2xl bg-white dark:bg-gray-900 p-8 shadow-2xl">
              <Dialog.Title className="text-2xl font-bold text-blue-700 dark:text-blue-300 mb-4">Upload Sharing Note</Dialog.Title>
